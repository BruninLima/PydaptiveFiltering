...
#                                                                               #
#     Adaptive Algorithm used here: RLSAlt                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.RLSAlt(filter_order=3, delta=10.0, forgetting_factor=0.99)
    ...
    print(f"[Example/RLSAlt] Total ensemble time: {perf_counter() - t0:.2f} s")
