...
#                                                                               #
#     Adaptive Algorithm used here: AffineProjectionCM                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    N, mu, delay, gamma, L = 5, 0.1, 1, 1e-10, 2
    ...
    for l in range(ensemble):
        ...
        flt = pdf.AffineProjectionCM(step_size=0.1, gamma=1e-10, memory_length=2, filter_order=4, w_init=w_init)
    ...
    print(f"[Example/AffineProjectionCM] Total ensemble time: {total_time:.2f} s ({total_time/ensemble:.3f} s/realization)")
    ...
    if plot:
        ...
        ax1.set_title("Equalizer output (AffineProjectionCM)")
