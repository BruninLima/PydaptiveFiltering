...
#                                                                               #
#     Adaptive Algorithm used here: SimplifiedSMAP                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.SimplifiedSMAP(filter_order=3, gamma_bar=1.0, gamma=1e-06, L=2)
    ...
    print(f"[Example/SimplifiedSMAP] Total ensemble time: {perf_counter() - t0:.2f} s")
