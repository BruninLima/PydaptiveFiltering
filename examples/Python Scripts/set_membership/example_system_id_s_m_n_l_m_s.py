...
#                                                                               #
#     Adaptive Algorithm used here: SMNLMS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.SMNLMS(filter_order=3, gamma_bar=1.0, gamma=1e-06)
    ...
    print(f"[Example/SMNLMS] Total ensemble time: {perf_counter() - t0:.2f} s")
