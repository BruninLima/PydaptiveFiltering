...
#                                                                               #
#     Adaptive Algorithm used here: SMAffineProjection                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.SMAffineProjection(gamma_bar=0.05, gamma=0.0001, L=2, gamma_bar_vector=[0.05, 0.05, 0.05], filter_order=3)
    ...
    print(f"[Example/SMAffineProjection] Total ensemble time: {perf_counter() - t0:.2f} s")
    ...
    if plot:
        plot_system_id_single_figure(
            ...
            theta_av=theta_av,
            poles_order=0,
            title_prefix="SMAffineProjection",
