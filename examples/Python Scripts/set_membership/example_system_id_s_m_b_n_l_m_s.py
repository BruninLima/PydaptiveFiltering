...
#                                                                               #
#     Adaptive Algorithm used here: SMBNLMS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.SMBNLMS(filter_order=3, gamma_bar=1.0, gamma=1e-06)
    ...
    print(f"[Example/SMBNLMS] Total ensemble time: {perf_counter() - t0:.2f} s")
