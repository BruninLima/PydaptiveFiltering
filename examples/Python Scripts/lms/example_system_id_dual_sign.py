...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.DualSign(rho=0.5, gamma=2.0, step_size=0.01, filter_order=3)
    ...
    print(f"[Example/DualSign] Total ensemble time: {perf_counter() - t0:.2f} s")
