...
#                                                                               #
#     Adaptive Algorithm used here: TDomainDFT                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.TDomainDFT(gamma=0.001, alpha=0.99, initial_power=1.0, step_size=0.005, filter_order=3)
    ...
    print(f"[Example/TDomainDFT] Total ensemble time: {perf_counter() - t0:.2f} s")
