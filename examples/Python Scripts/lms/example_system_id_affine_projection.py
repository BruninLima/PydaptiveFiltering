...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.AffineProjection(step_size=0.01, L=2, gamma=0.0001, filter_order=3)
    ...
    print(f"[Example/AffineProjection] Total ensemble time: {perf_counter() - t0:.2f} s")
