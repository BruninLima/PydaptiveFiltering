...
#                                                                               #
#     Adaptive Algorithm used here: Power2ErrorLMS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.Power2ErrorLMS(bd=8, tau=0.25, step_size=0.01, filter_order=3)
    ...
    print(f"[Example/Power2ErrorLMS] Total ensemble time: {perf_counter() - t0:.2f} s")
