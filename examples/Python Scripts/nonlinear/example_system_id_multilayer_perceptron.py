...
#                                                                               #
#     Adaptive Algorithm used here: MultilayerPerceptron                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    print(f"[Example/MultilayerPerceptron] Total ensemble time: {perf_counter() - t0:.2f} s")
    ...
    if plot:
        plot_system_id_single_figure(
            ...
            theta_av=theta_av,
            poles_order=0,
            title_prefix="MultilayerPerceptron",
