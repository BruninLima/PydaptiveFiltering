...
#                                                                               #
#     Adaptive Algorithm used here: ComplexRBF                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.ComplexRBF(n_neurons=12, input_dim=4, sigma_init=3.0, uw=0.1, ur=0.001, us=0.001, w_init=np.zeros(12, dtype=np.complex128))
    ...
    print(f"[Example/ComplexRBF] Total ensemble time: {perf_counter() - t0:.2f} s")
