...
#                                                                               #
#     Adaptive Algorithm used here: VolterraRLS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    print(f"[Example/VolterraRLS] Total ensemble time: {perf_counter() - t0:.2f} s")
