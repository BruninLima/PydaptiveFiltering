...
#                                                                               #
#     Adaptive Algorithm used here: BilinearRLS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    print(f"[Example/BilinearRLS] Total ensemble time: {perf_counter() - t0:.2f} s")
