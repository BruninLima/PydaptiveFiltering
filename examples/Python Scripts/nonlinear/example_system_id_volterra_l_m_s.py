...
#                                                                               #
#     Adaptive Algorithm used here: VolterraLMS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    print(f"[Example/VolterraLMS] Total ensemble time: {perf_counter() - t0:.2f} s")
