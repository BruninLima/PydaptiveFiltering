...
#                                                                               #
#     Adaptive Algorithm used here: LRLSPriori                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.LRLSPriori(filter_order=3)
    ...
    print(f"[Example/LRLSPriori] Total ensemble time: {perf_counter() - t0:.2f} s")
