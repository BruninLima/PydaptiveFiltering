...
#                                                                               #
#     Adaptive Algorithm used here: NormalizedLRLS                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.NormalizedLRLS(epsilon=10.0, filter_order=3)
    ...
    print(f"[Example/NormalizedLRLS] Total ensemble time: {perf_counter() - t0:.2f} s")
