...
#                                                                               #
#     Adaptive Algorithm used here: LRLSPosteriori                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.LRLSPosteriori(filter_order=3, epsilon=10.0)
    ...
    print(f"[Example/LRLSPosteriori] Total ensemble time: {perf_counter() - t0:.2f} s")
