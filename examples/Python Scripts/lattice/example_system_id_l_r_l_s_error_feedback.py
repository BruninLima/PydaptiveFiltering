...
#                                                                               #
#     Adaptive Algorithm used here: LRLSErrorFeedback                                 #
#                                                                               #
#################################################################################
...
def main(seed: int = 0, plot: bool = True):
    ...
    for l in range(ensemble):
        ...
        flt = pdf.LRLSErrorFeedback(filter_order=3, epsilon=10.0)
    ...
    print(f"[Example/LRLSErrorFeedback] Total ensemble time: {perf_counter() - t0:.2f} s")
    ...
    if plot:
        plot_system_id_single_figure(
            ...
            theta_av=theta_av,
            poles_order=0,
            title_prefix="LRLSErrorFeedback",
