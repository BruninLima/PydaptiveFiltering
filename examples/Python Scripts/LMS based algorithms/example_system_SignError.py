...
def SignError_example():
    """
    Types:
    ------
    None -> '(Filter, dictionary["outputs", "errors", "coefficients"])'

    Example for the SignError algorithm, SignData and SignError. 
    ...
    print(" Adapting with SignError algorithm")

    # Adapting with SignError algorithm
    Output = pdf.LMS.SignError(Filter, d, x, mu)
...
if __name__ == "__main__":
    # Running example
    Filter, Output, ComplexNoise = SignError_example()
